    ...
    <div class="container">
        ...
        <div class="nav-collapse collapse navbar-inverse-collapse">
            ...
            <form class="navbar-search pull-left input-append" action="#">
             ...
             <button onclick="callSSO()" style="margin-top: 15px; margin-left: 10px">Login SSO</button>
     ...
     function callSSO() {
        ...
        fetch(`<%=request.getContextPath()%>/api/v1/auth/sso?username=<%=request.getSession().getAttribute("USER")%>`)
