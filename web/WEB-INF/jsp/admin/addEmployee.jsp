                    ...
                    <form:form method="POST" action="add.html" commandName="employee" cssClass="form-horizontal row-fluid">
                        <!--<form class="form-horizontal row-fluid">-->
                          <div class="control-group">
                            ...
                            <div class="controls">
                                <form:input class="span8" path="idEmployee" id="basicinput"  placeholder="Type something here..."/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="basicinput">Employee Number</label>
                            <div class="controls">
                                <form:input class="span8" path="employeeNumber" id="basicinput" placeholder="Type something here..."/>
                            </div>
                        </div>
